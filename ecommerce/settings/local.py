...
STRIPE_SECRET_KEY = os.environ.get("STRIPE_SECRET_KEY", "sk_test_44NNINOVFofUiCP8A9SCginx00MTXhrXIq")
STRIPE_PUB_KEY = os.environ.get("STRIPE_PUB_KEY", 'pk_test_hULczefdKnXOcqZqEyjcukf2007fUTdyyS')
